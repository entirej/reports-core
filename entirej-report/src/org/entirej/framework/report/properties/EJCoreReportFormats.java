...
public class EJCoreReportFormats
{
    ...
    public static class ReportFormat
    {
        ...
        private ReportFormat(String name, int reportWidth, int reportHeight, int numCols, int marginTop, int marginBottom, int marginLeft, int marginRight)
        {
            super();
            this.name = name;
