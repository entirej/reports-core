...
public class EJReportVisualAttributeProperties implements Comparable<EJReportVisualAttributeProperties>, Serializable
{
    ...
    public EJReportVisualAttributeProperties(String name)
    {
        _name = name;
    }
     ...
     *         {@link EJReportVisualAttributeProperties#UNSPECIFIED}
     */
    ...
    {
        EJReportVisualAttributeProperties props = new EJReportVisualAttributeProperties();
        props.setName(_name);
    ...
    public int compareTo(EJReportVisualAttributeProperties o)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        if (getClass() != obj.getClass())
            return false;
        EJReportVisualAttributeProperties other = (EJReportVisualAttributeProperties) obj;
        if (_name == null)
        {
            if (other._name != null)
                return false;
