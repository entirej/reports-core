...
public abstract class EJCoreReportPropertiesTagHandler extends DefaultHandler implements Serializable
{
    // delegate handling
    private EJCoreReportPropertiesTagHandler _delegateHandler = null;
    ...
    protected void setDelegate(EJCoreReportPropertiesTagHandler delegateHandler)
    {
        _delegateHandler = delegateHandler;
    }

    protected EJCoreReportPropertiesTagHandler getDelegate()
    {
