...
public class EJReportImageScreenItem extends EJReportValueBaseScreenItem 
{
    EJCoreReportScreenItemProperties.Image item;

    public EJReportImageScreenItem(EJCoreReportScreenItemProperties.Image item)
    {
        super(item);
        this.item = item;
    }
