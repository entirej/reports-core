...
public class EJReportNumberScreenItem extends EJReportValueBaseScreenItem implements EJReportRotatableScreenItem
{
    EJCoreReportScreenItemProperties.Number item;

   public EJReportNumberScreenItem(EJCoreReportScreenItemProperties.Number item)
    {
        super(item);
        this.item = item;
    }
