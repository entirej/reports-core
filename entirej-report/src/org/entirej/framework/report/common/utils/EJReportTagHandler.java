...
public abstract class EJReportTagHandler extends DefaultHandler
{
    // child handlers
    private EJReportTagHandler _currentSubHandler = null;
    ...
    public EJReportTagHandler getCurrentSubHandler()
    {
        return _currentSubHandler;
    }

    public void setCurrentSubHandler(EJReportTagHandler subHandler)
    {
