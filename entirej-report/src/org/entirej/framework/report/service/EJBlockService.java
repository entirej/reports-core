...
public interface EJBlockService<E> extends Serializable
{
     ...
     */
    public List<E> executeQuery(EJReport form, EJQueryCriteria queryCriteria);
     ...
     *            The new entities
     */
    public void executeInsert(EJReport form, List<E> newEntities);
     ...
     */
    public void executeUpdate(EJReport form, List<E> modifiedEntities);
     ...
     */
    public void executeDelete(EJReport form, List<E> entitiesToDelete);
