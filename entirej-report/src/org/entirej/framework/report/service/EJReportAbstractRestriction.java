...
public abstract class EJReportAbstractRestriction<E> implements EJReportRestriction<E>
{
    ...
    private List<Entry<EJReportRestrictionJoin, EJReportRestriction<?>>> _restrictions = new ArrayList<Entry<EJReportRestrictionJoin, EJReportRestriction<?>>>();

    @Override
    public abstract EJReportRestrictionType getType();
    ...
    /**
     * If the restriction is of type {@link EJReportRestrictionType#BETWEEN}
     * then there will be a low value and a high value, this method returns the
     * high value.
     * <p>
     ...
     * then <code>{@link EJReportRestrictionType#BETWEEN}</code>
     * 
     ...
     * {@link EJReportRestrictionType#IN} or
     * {@link EJReportRestrictionType#NOT_IN}
     * 
    ...
    public void add(EJReportRestrictionJoin join, EJReportRestriction<?> restriction)
    {
        ...
        _restrictions.add(new JoinEntry<EJReportRestrictionJoin, EJReportRestriction<?>>(join, restriction));

    }

    public List<Entry<EJReportRestrictionJoin, EJReportRestriction<?>>> getSubRestrictions()
    {
        return new ArrayList<Entry<EJReportRestrictionJoin, EJReportRestriction<?>>>(_restrictions);
    }
