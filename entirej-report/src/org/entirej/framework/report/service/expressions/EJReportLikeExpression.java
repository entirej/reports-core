...
class EJReportLikeExpression implements Serializable
{
    private String _value;

    EJReportLikeExpression(String value)
    {
        if (value == null)
        {
            throw new EJReportRuntimeException(new EJReportMessage("A Like expression must contain a value"));
        }
