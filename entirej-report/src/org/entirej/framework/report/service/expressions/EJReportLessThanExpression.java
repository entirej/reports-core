...
class EJReportLessThanExpression implements Serializable
{
    private String _string;

    EJReportLessThanExpression(String string)
    {
        if (string == null)
        {
            throw new EJReportRuntimeException(new EJReportMessage("A LessThan expression must contain a value"));
        }
