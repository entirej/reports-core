...
public class EJReportQuerySort implements Serializable
{
    private String                _sort;
    private EJReportQuerySortType _sortType;

    public static EJReportQuerySort ASC(String sort)
    {
        return new EJReportQuerySort(sort, EJReportQuerySortType.ASCENDING);
    }
     ...
     */
    public static EJReportQuerySort DESC(String sort)
    {
        return new EJReportQuerySort(sort, EJReportQuerySortType.DESCENDING);
    }
     ...
     */
    private EJReportQuerySort(String sort, EJReportQuerySortType type)
    {
        _sort = sort;
        _sortType = type;
    }
     ...
     */
    public EJReportQuerySortType getType()
    {
        return _sortType;
    }
