...
public class EJReportPojoGeneratorType
{
    private Collection<EJReportTableColumn> _columnNames;
    ...
    public Collection<EJReportTableColumn> getColumns()
    {
        return _columnNames;
    }

    public void setColumnNames(Collection<EJReportTableColumn> columns)
    {
