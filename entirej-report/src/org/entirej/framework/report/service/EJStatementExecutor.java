...
public class EJStatementExecutor implements Serializable
{
    ...
    public int executeDelete(EJReport form, String tableName, EJStatementCriteria criteria, EJStatementParameter... parameters)
    {
        if (form == null)
        {
    ...
    public int executeDelete(EJReportFrameworkConnection connection, String tableName, EJStatementCriteria criteria, EJStatementParameter... parameters)
    {
    ...
    public int executeInsert(EJReport form, String tableName, EJStatementParameter... parameters)
    {
        if (form == null)
        {
    ...
    public int executeInsert(EJReportFrameworkConnection connection, String tableName, EJStatementParameter... parameters)
    {
    ...
    public int executeUpdate(EJReport form, String tableName, EJStatementCriteria criteria, EJStatementParameter... parameters)
    {
        if (form == null)
        {
    ...
    public int executeUpdate(EJReportFrameworkConnection fwkConnection, String tableName, EJStatementCriteria criteria, EJStatementParameter... parameters)
    {
    ...
    private int executeStatement(EJReportFrameworkConnection fwkConnection, String statement, EJStatementCriteria criteria, EJStatementParameter... parameters)
    {
        if (fwkConnection == null)
        {
            throw new NullPointerException("No EJReportFrameworkConnection passed to the EJStatementExecutor");
        }
        ...
        catch (Exception e)
        {
            ...
            throw new EJReportRuntimeException("Error executing update statement: " + e.getMessage(), e);
        }
        finally
        {
            try
    ...
    public int executeStoredProcedure(EJReport form, String procedureStatement, EJStoredProcedureStatementParameter... parameters)
    {
        if (form == null)
        {
    ...
    public int executeStoredProcedure(EJReportFrameworkConnection fwkConnection, String procedureStatement, EJStoredProcedureStatementParameter... parameters)
    {
        if (fwkConnection == null)
        {
            throw new NullPointerException("The EJReportFrameworkConnection passed to the EJStatementExecutor is null");
        }
        ...
        catch (Exception e)
        {
            ...
            fwkConnection.rollback();
            throw new EJReportRuntimeException("Error executing stored procedure", e);
        }
        finally
        {
            try
    ...
    public <T> List<T> executeQuery(Class<T> pojoType, EJReport form, String selectStatement, EJQueryCriteria queryCriteria)
    {
        return executeQuery(pojoType, form.getConnection(), selectStatement, queryCriteria);
    }

    public <T> List<T> executeQuery(Class<T> pojoType, EJReportFrameworkConnection fwkConnection, String selectStatement, EJQueryCriteria queryCriteria)
    {
    ...
    private <T> List<T> executeQuery(Class<T> pojoType, EJReportFrameworkConnection fwkConnection, String selectStatement, EJQueryCriteria queryCriteria,
    ...
    public List<EJSelectResult> executeQuery(EJReport form, String selectStatement, EJQueryCriteria queryCriteria, EJStatementParameter... parameters)
    {
        if (form == null)
        {
    ...
    public List<EJSelectResult> executeQuery(EJReport form, String selectStatement, EJStatementParameter... parameters)
    {
        if (form == null)
        {
            throw new NullPointerException("Form passed to executeQuery cannot be null");
    ...
    public List<EJSelectResult> executeQuery(EJReportFrameworkConnection fwkConnection, String selectStatement, EJStatementParameter... parameters)
    {
        return executeQuery(fwkConnection, selectStatement, null, parameters);
    }

    public List<EJSelectResult> executeQuery(EJReportFrameworkConnection fwkConnection, String selectStatement, EJQueryCriteria queryCriteria,
            EJStatementParameter... parameters)
    {
        if (fwkConnection == null)
        {
