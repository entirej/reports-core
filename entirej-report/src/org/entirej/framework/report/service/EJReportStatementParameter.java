...
public class EJReportStatementParameter implements Serializable
{
    private int                               _type;
    ...
    public EJReportStatementParameter(EJReportParameterType paramType)
    {
        this(null, null, paramType, null);
    }

    public EJReportStatementParameter(Object value)
    {
        this(null, null, EJReportParameterType.IN, value);
    }

    public EJReportStatementParameter(String fieldName, EJReportParameterType paramType, Object value)
    {
        this(fieldName, null, paramType, value);
    }

    public EJReportStatementParameter(String fieldName, Class<?> type)
    {
        this(fieldName, type, EJReportParameterType.IN, null);
    }

    public EJReportStatementParameter(String fieldName, Class<?> type, EJReportParameterType paramType)
    {
        this(fieldName, type, paramType, null);
    }

    public EJReportStatementParameter(String fieldName, Class<?> type, Object value)
    {
        this(fieldName, type, EJReportParameterType.IN, value);
    }

    public EJReportStatementParameter(String fieldName, Class<?> type, EJReportParameterType paramType, Object value)
    {
        if (paramType == null)
        {
    ...
    public EJReportParameterType getParameterType()
    {
